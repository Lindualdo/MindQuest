...
const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Fale com a central MindQuest no WhatsApp +351 928 413 957. Enviamos um link seguro com token para ativar o dashboard em poucos minutos.',
    cta: {
          ...
          <section className="bg-gradient-to-br from-indigo-700 via-indigo-600 to-purple-700 rounded-3xl shadow-2xl p-8 md:p-12 text-white space-y-6 border border-white/20">
            <div className="space-y-4">
              ...
              <p className="text-indigo-100 leading-relaxed max-w-3xl">
                Entre agora para uma experiência guiada, com suporte humano e inteligência emocional
                personalizada. Ative seu MindQuest e comece a gerar clareza em minutos.
              </p>
            </div>
