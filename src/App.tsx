...
import PaginaInicialV12 from './pages/App/v1.2/PaginaInicialV12';
    ...
    <AuthGuard>
      <div className="mindquest-dashboard min-h-screen">
        ...
        <motion.header
          ...
          style={{ backgroundColor: '#E8F3F5', borderBottom: '1px solid rgba(28,37,65,0.08)' }}
        >
          <div className="max-w-6xl mx-auto flex items-center justify-between gap-3 px-4 py-2">
            <div className="flex items-center gap-3">
              ...
              <div className="leading-tight">
                <p className="text-sm font-semibold" style={{ color: '#D90368' }}>MindQuest</p>
                <p className="text-xs" style={{ color: '#7EBDC2' }}>mente clara · v1.1.6</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <button
                ...
                onClick={handleRefresh}
                disabled={isLoading}
                className="inline-flex items-center justify-center rounded-full border px-3 py-2 text-sm"
                style={{ borderColor: 'rgba(48,131,220,0.3)', color: '#1C2541' }}
