...
const FraseTransformacao = () => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-wrap items-center gap-1.5 rounded-3xl border px-4 py-2 text-[0.65rem] sm:text-[0.78rem]"
      style={{
    ...
    >
      <p className="font-semibold tracking-tight text-[0.65rem] sm:text-[0.78rem]">
      ...
      <motion.span
        ...
        className="rounded-full px-3 py-0.5 text-[0.7rem] font-semibold sm:text-[0.8rem]"
        style={{
