...
const HeaderV1_2 = ({ nomeUsuario, onRefresh }: Props) => (
  ...
  >
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-1 px-4 py-1.5">
      <div className="flex w-full flex-wrap items-center justify-between gap-2">
        <div className="flex min-w-[120px] flex-col items-center gap-1 text-center text-[#1C2541]">
