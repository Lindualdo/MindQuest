...
- Removido mensões ao APP
- estava se perdendo e confundindo o usr
- distração, manda o usr para o app, e perde o foco da conversa
- vamos implementar de outra forma